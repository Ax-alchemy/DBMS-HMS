    ...
    <div class="content">
      ...
      <form action="/adduser" method="post">
        ...
        <div class="form-group content">
		  ...
		  <br>  
		  <input type="radio" id="gender" name="gender" value="female"/> Female <br/>          </div>
        <div class="form-group">
          <label for="address">Address</label>
          <input type="text" class="form-control" id="address" placeholder="house no., street, city, pincode, city" name="address" required>
        </div>
        <br>
      ...
      <a href="/patsignin"><button class="btn btn-warning">Login</button></a><br><br>
      
      <a href="/docsignin"><button class="btn btn-info">Login as Doctor</button></a>
